...
IMPORTANT_SENDERS = {"jobalerts-noreply@linkedin.com": "💼 Job Alerts"}
IMPORTANT_KEYWORDS = {"urgent", "breaking", "action required", "opportunity"}
...
def fetch_unread_emails():
    """Fetch unread emails from Gmail and categorize them."""
    ...
    categorized_emails = {"📌 Important Emails": [], "📢 Breaking News": [], "💼 Job Alerts": [], "✉️ General Emails": []}
